  ...
  return (
    <div className="py-16 lg:py-24">
     ...
     <SectionHeader eyebrow="Happy Clients" title="What Clients Say About Me" description="Don't just take my word for it. See what my clients have to say about my work." />
      ...
      <div className="flex gap-8 flex-none animate-move-left [animationDuration:90s] hover:[animation-play-state:paused]">
        ...
        {testimonials.map((testimonial) => (
         ...
         <div className="flex gap-4 items-center">
          ...
          <div>
            ...
            <p className="text-sm md:mt-5 lg:mt-4 mt-4 md:text-base">{testimonial.text}</p>
          </Card>
        ))}
        </Fragment>
      ))}

...
import mapImage from "@/assets/images/bd-map2.png";
  ...
  return <div className="py-20 lg:py-28">
    ...
    <div className="mt-20 flex flex-col gap-8">
      ...
      <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
          <Image src={mapImage} alt="Map" className="h-full w-full"/>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 rounded-full bg-gradient-to-r from-blue-950 to-gray-900 after-content[''] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-full after:outline-gray-950/30">
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-950 to-gray-900 -z-20 animate-ping [animation-duration:2s]"></div>
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-950 to-gray-900 -z-10"></div>
